...
class ProspectFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        for ($i = 0; $i < 30; $i++) {
            ...
            if (in_array($prospect->getStatus(), ['contacted', 'qualified', 'proposal_sent', 'negotiation'], true)) {
            ...
            if (in_array($prospect->getStatus(), ['proposal_sent', 'negotiation', 'converted'], true)) {
