    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('centerEvaluator', EntityType::class, [
                'class' => Teacher::class,
                'choice_label' => static fn (Teacher $teacher) => $teacher->getFirstName() . ' ' . $teacher->getLastName(),
            ...
            ->add('mentorEvaluator', EntityType::class, [
                'class' => Mentor::class,
                'choice_label' => static fn (Mentor $mentor) => $mentor->getFirstName() . ' ' . $mentor->getLastName() . ' (' . $mentor->getCompanyName() . ')',
            ...
            ->add('relatedMission', EntityType::class, [
                ...
                'choice_label' => static fn (MissionAssignment $assignment) => $assignment->getMission()->getTitle() . ' (' . $assignment->getStudent()->getFirstName() . ' ' . $assignment->getStudent()->getLastName() . ')',
