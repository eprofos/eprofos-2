...
class Teacher implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @var list<string> The teacher roles
     */
    #[ORM\Column]
    private array $roles = [];
    ...
    #[ORM\Column(length: 100, nullable: true)]
    #[Assert\Length(max: 100, maxMessage: 'La spécialité ne peut pas dépasser 100 caractères')]
    ...
    #[Assert\Length(max: 200, maxMessage: 'Les qualifications ne peuvent pas dépasser 200 caractères')]
    ...
    public function getExperienceDescription(): string
    {
        ...
        return $this->yearsOfExperience . ' ans d\'expérience';
    }
