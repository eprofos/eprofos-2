...
class TeacherFixturesTest extends KernelTestCase
{
    ...
    public function testTeacherStatusVariety(): void
    {
        ...
        $verifiedTeachers = array_filter($allTeachers, fn($t) => $t->isEmailVerified());
        $unverifiedTeachers = array_filter($allTeachers, fn($t) => !$t->isEmailVerified());
        ...
        $activeTeachers = array_filter($allTeachers, fn($t) => $t->isActive());
        $inactiveTeachers = array_filter($allTeachers, fn($t) => !$t->isActive());
    ...
    public function testTeacherSpecialtyVariety(): void
    {
        ...
        $specialties = array_unique(array_map(fn($t) => $t->getSpecialty(), $allTeachers));
    ...
    public function testExperienceLevels(): void
    {
        ...
        $experiences = array_map(fn($t) => $t->getYearsOfExperience(), $allTeachers);
        $experiences = array_filter($experiences, fn($e) => $e !== null);
